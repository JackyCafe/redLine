					...
					<div class="nav-header">
						...
						<div class="col-md-10" style="padding: 0 !important"
							...
							<%
								...
								DetailBeanService detailService = new DetailBeanService(
								...
								DetailBean detail = detailService.select(id);
								System.out.print("<br>"+detail);
					...
					<div class="col-md-10">
						<div class="row" style="padding: 20px 15px 40px 15px">
							<div class="col-md-6 animate-box">
								<img src='images/<c:out value="${detail.pics }"/>' width="100%">
							</div>
							<div class="col-md-6 animate-box">
								<div class="">
									<c:out value="${detail.proddesc}"/>
									( <c:out value="${detail.color}" />-<c:out value="${detail.size}" />) 
									<br> NT$<c:out value="${detail.price}"/><br> 商品編號：<c:out value="${detail.prod_id}"/>
								</div>
								<div class="">
									<div class="picksize">
