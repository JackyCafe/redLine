				...
				<div class="container">
					<div class="nav-header">
						...
						<div class="col-md-10" style="height: 50px; padding: 0 !important"
							...
							<div id="weather">
								<ul id="weather-menu">
									<li>æ¥<img src="images/partly_cloudy_day.png" width="20"
										height="20">15-20
									</li>
									<li>ä¸<img src="images/partly_cloudy_night.png"
										width="20" height="20">15-20
									</li>
									<li>äº<img src="images/scattered_showers_day_night.png"
										width="20" height="20">15-20
									</li>
									<li>ä¸<img src="images/clear_day.png" width="20"
										height="20">15-20
									</li>
									<li>å<img src="images/partly_cloudy_day.png" width="20"
										height="20">15-20
									</li>
									<li>äº<img src="images/partly_cloudy_day.png" width="20"
										height="20">15-20
									</li>
									<li>å­<img src="images/clear_day.png" width="20"
										height="20">15-20
									</li>
								</ul>
							</div>
...
<%
							...
							%>
							<span id="cart"><a href="../pages/Register.jsp">加入會員</a>
								| <a href="#" id='loginClick'>會員登入</a> | <i class="icon-cart2"></i> <a href="#">0</a>個商品
							</span>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="col-md-12" style="padding: 0; margin: 2em 0">
					<div class="flexslider">
						<ul class="slides">
							<li><img src="images/EDM_1160X570.jpg" width="100%" /></li>
							<li><img src="images/EDM_1160X570.jpg" width="100%" /></li>
							<li><img src="images/EDM_1160X570.jpg" width="100%" /></li>
							<li><img src="images/EDM_1160X570.jpg" width="100%" /></li>
							<li><img src="images/EDM_1160X570.jpg" width="100%" /></li>
