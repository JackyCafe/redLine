						...
						<div class="col-md-10" style="padding: 0 !important"
							...
							<nav id="fh5co-menu-wrap" role="navigation">
								<ul class="sf-menu" id="fh5co-primary-menu">
									<li><a href='women.jsp?category=<c:out value="${primary[0].getCategory()}"/>'><c:out
												value="${primary[0].getCategory()}" /></a>
										<ul class="fh5co-sub-menu">
											 
										</ul></li>
									<li><a href="women.jsp"><c:out
												value="${primary[1].getCategory()}" /></a>
										<ul class="fh5co-sub-menu">
									...
									<li><a href="women.jsp"><c:out value="${primary[2].getCategory()}" /></a>
										<ul class="fh5co-sub-menu">
												<%
									...
									<li><a href="women.jsp"><c:out value="${primary[3].getCategory()}" /></a>
										<ul class="fh5co-sub-menu">
										<%
									...
									<li><a href="women.jsp"><c:out value="${primary[4].getCategory()}" /></a>
										<ul class="fh5co-sub-menu">
											<%
					...
					<div class="col-md-10">
						<div class="row">
 						...
 						<sql:query var="r" dataSource="jdbc/xxx">
   							 select * from detail,minorCategory where  detail.item = minorCategory.item
 					</sql:query>
 						<div class="row">
